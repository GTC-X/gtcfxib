...
const AwardCarousel = () => {
  const t = useTranslations("metaData.awards");
  ...
  return (
    <section className="md:py-12 3xl:py-16 py-8 ib-award">
      <div className="container text-center">
        <h2 className="HeadingH2 font-semibold mb-10">{t("title")}</h2>
        <Swiper
        ...
        >
          {awardsList.map((award, index) => (
            <SwiperSlide key={index} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              <div className="flex flex-row px-2 py-4 border-[5px] border-[#F1F1F1] items-center cursor-pointer hover:shadow-2xl transition-shadow duration-300 ease-in-out w-[100%]">
